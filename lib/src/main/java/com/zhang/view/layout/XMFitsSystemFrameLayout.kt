...
/**
 * 适应状态栏高度的[FrameLayout]，并且能兼容
 *
 * @author ZhangXiaoMing 2024-04-14 21:49 周日
 */
class XMFitsSystemFrameLayout @JvmOverloads constructor(
    context : Context ,
...
//        }
    ...
    class LayoutParams : FrameLayout.LayoutParams {
        ...
        constructor(c : Context , attrs : AttributeSet?) : super(c , attrs) {
            val array = c.obtainStyledAttributes(attrs , R.styleable.XMFitsSystemFrameLayout)
    ...
    companion object {
        ...
        private const val TAG = "XMFitsSystemFrameLayout"
    }
}

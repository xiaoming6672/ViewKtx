...
/**
 * 适应状态栏高度的[LinearLayout]，并且能兼容
 *
 * @author ZhangXiaoMing 2024-04-14 21:49 周日
 */
class XMFitsSystemLinearLayout @JvmOverloads constructor(
    context : Context ,
...
//        }
    ...
    class LayoutParams : LinearLayout.LayoutParams {
        ...
        constructor(c : Context , attrs : AttributeSet?) : super(c , attrs) {
            val array = c.obtainStyledAttributes(attrs , R.styleable.XMFitsSystemLinearLayout)
    ...
    companion object {
        ...
        private const val TAG = "XMFitsSystemLinearLayout"
    }
}

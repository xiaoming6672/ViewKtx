...
/**
 * 适应状态栏高度的[ConstraintLayout]，并且能兼容
 *
 * @author ZhangXiaoMing 2024-04-14 21:49 周日
 */
class XMFitsSystemConstraintLayout @JvmOverloads constructor(
    context : Context ,
...
//        }
    ...
    class LayoutParams : ConstraintLayout.LayoutParams {
        ...
        constructor(c : Context , attrs : AttributeSet?) : super(c , attrs) {
            val array = c.obtainStyledAttributes(attrs , R.styleable.XMFitsSystemConstraintLayout)
    ...
    companion object {
        ...
        private const val TAG = "XMFitsSystemConstraintLayout"
    }
}
